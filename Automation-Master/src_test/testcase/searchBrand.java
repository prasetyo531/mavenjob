...
public static Logger log =LogManager.getLogger(support.class.getName());
	...
	public void scenario_satu(String email,String password,String alamat,String telepon) throws Exception {
        ...
        Assert.assertEquals(UrlBrand1, "http://reviews.femaledaily.com/brands/nivea?tab=products&page=1");
        ...
        //verify most product
        String mostProductFromA = (String) conn.getfromDatabaseBrands_totalProduct("SELECT brands_item FROM nubr_brands WHERE brands_item LIKE'A%' ORDER BY brands_total_product DESC LIMIT 1;", "staging");
		...
		//verify most review
		String mostReviewFromA = (String) conn.getfromDatabaseBrands_totalProduct("SELECT brands_item FROM nubr_brands WHERE brands_item LIKE'A%' ORDER BY brands_total_review_num DESC LIMIT 1;", "staging");
