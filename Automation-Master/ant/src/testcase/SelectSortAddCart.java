...
public class SelectSortAddCart extends controller {
	
	 public String productSelectSortAddCart = "Mondy Chair";
	...
	public static String createRandom(int Digits) {
		...
		public void scenario_satu() throws Exception {
		  ...
		  //Sort
		  driver.findElement(By.linkText("Rendah")).click();
		  ...
		  if (Sort == true){
			  ...
			  driver.findElement(By.linkText(this.productSelectSortAddCart)).click();
			  
			  Select dropdown = new Select(driver.findElement(By.id("select-swatches")));
			  dropdown.selectByVisibleText("Ruby Vienna");
			  ...
			  getscreenshot();
			  	...
			  	if(cartBox.contains(this.productSelectSortAddCart)) {
			  		System.out.println("Select Sort AddCart Apply-Success");
