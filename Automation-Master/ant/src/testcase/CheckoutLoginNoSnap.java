...
public class CheckoutLoginNoSnap extends controller {
...
public String productSelectAddCart ="Jobi Armchair";
	...
	boolean newAddress = driver.findElement(By.xpath("//*[@id='address-form-modal']")).isDisplayed(); 
	 ...
	 Thread.sleep(5000); //check default selection
		...
		driver.findElement(By.cssSelector("input[name='lastname']")).sendKeys("checkout");
		...
		waitSeconds(6);
		//(new WebDriverWait(driver, 10)).until(ExpectedConditions.elementToBeClickable(By.cssSelector("select[name='city_id']")));  //city
        ...
        waitSeconds(6);
        //(new WebDriverWait(driver, 10)).until(ExpectedConditions.elementToBeClickable(By.cssSelector("select[name='subdistrict_id']")));
        ...
        (new WebDriverWait(driver, 10)).until(ExpectedConditions.elementToBeClickable(By.cssSelector("#btn-next-address > div:nth-child(1) > button:nth-child(1)")));
        ...
        //driver.findElement(By.cssSelector("#btn-next-address > div:nth-child(1) > button:nth-child(1)")).click();
        ...
        waitSeconds(2);
		driver.findElement(By.id("banktransfer")).click(); //select payment method
